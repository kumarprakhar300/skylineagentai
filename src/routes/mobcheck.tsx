...
const leadsQuery = queryOptions({
  ...
  queryFn: async () => ({
    leads: [
      {
        id: "l1", call_id: "c1", name: "Rohit Deshpande", phone: "+91 98765 43210",
        intent: "buy", location: "Wakad, Pune", property_type: "apartment",
        configuration: "3 BHK", budget: "1.2 crore – 1.4 crore", purpose: "self use",
        timeline: "immediate", score: 92, score_band: "hot",
        score_reasons: ["Budget matched", "Immediate timeline"], status: "contacted",
        owner_notes: "Wants weekend site visit", callback_at: null, created_at: new Date().toISOString(),
      },
    ] as unknown as LeadRow[],
    calls: [
      {
        id: "c1", channel: "phone", language: "hinglish", status: "completed",
        started_at: new Date().toISOString(),
        summary: "Caller is looking for a 3 BHK in Wakad within 1.4 crore, ready to visit this weekend.",
        transcript: [
          { role: "assistant", content: "Namaste, main Aarav bol raha hoon Skyline Estates se." },
...
export const Route = createFileRoute("/mobcheck")({
